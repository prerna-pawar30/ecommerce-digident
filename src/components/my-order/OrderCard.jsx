...
const OrderCard = ({ order, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="group bg-white border border-gray-200 rounded-2xl overflow-hidden hover:border-[#E68736]/50 hover:shadow-xl transition-all duration-300 cursor-pointer"
    >
      <div className="bg-gray-50/50 px-6 py-3 border-b border-gray-100 flex flex-wrap justify-between items-center gap-4">
      ...
      <div className="p-6 flex flex-col md:flex-row items-center gap-6">
        <div className="w-24 h-24 bg-white rounded-xl border border-gray-100 p-2 group-hover:scale-105 transition-transform">
        ...
        <div className="flex-grow text-center md:text-left">
          ...
          <div className="flex items-center justify-center md:justify-start gap-4 mt-3">
            <span className="flex items-center gap-1 text-xs text-gray-400 font-medium bg-gray-100 px-2 py-1 rounded">
